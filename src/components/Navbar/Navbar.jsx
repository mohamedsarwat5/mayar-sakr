...
export default function Navbar() {
    ...
    return (<>
        ...
        <nav className={`  bg-light-red dark:bg-mblack shadow-lg dark:shadow-sm transition-colors duration-300 lg:dark:shadow-gray-700 dark:text-white  text-black  sticky top-0 z-40 w-full`}>
